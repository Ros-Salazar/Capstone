 ...
 import {getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword} from "https://www.getstatic.com/firebasejs/11.1.0/firebase-auth.js";
 ...
 signUp.addEventListener('click', (event)=>{
    ...
    .then((userCredential)=>{
        ...
        .then(()=>{
            window.location.href='projectTab.html';
        })
        .catch((error)=>{
